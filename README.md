...
| **MLP** | 0.9974 | 589,080 | High accuracy but computationally more expensive than LR. |
| **SVM** | 0.6549 | 7,165,693 | Failed to capture the underlying data structure effectively. |
